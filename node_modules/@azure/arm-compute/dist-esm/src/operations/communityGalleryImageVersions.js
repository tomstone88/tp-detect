...
export class CommunityGalleryImageVersionsImpl {
    ...
    listPagingPage(location, publicGalleryName, galleryImageName, options) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            let result = yield __await(this._list(location, publicGalleryName, galleryImageName, options));
    ...
    listPagingAll(location, publicGalleryName, galleryImageName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(location, publicGalleryName, galleryImageName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
