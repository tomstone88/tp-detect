 ...
 */
export async function generateReport(results: ScanResult[], options: ScanOptions): Promise<void> {
 ...
 */
function generateTextReport(results: ScanResult[]): string {
 ...
 */
function generateSummaryReport(results: ScanResult[]): string {
